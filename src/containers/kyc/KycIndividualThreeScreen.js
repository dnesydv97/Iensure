...
import IndividualStepThree from '../../layout/kyc/IndividualStepThree';
...
class KycIndividualThreeScreen extends React.Component {
   ...
   */
  processForm(event) {
    this.props.localKycSave(this.state.kycData, 3);
    this.props.navigation.navigate('KycIndividualStepFour');
  }
  /**
   * Process the form.
   *
