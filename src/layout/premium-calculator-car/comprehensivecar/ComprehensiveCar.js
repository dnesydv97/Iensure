...
import PremiumCalculatorFormCar from '../../../components/PremiumCalculatorFormCar';
...
const CarCalculator = () => {
  ...
  const {premeCalcLoading} = useSelector(
    state => state.PremiumCalculatorFormReducer,
  );

  // const loading = useSelector(
  //   state => state.PremiumCalculatorTwoReducer.loadingUi,
  // );
  useEffect(() => {
  ...
  const [compulsory, setCompulsoryValue] = useState('');
          ...
          <View style={{padding: 15}}>
            <View>
              <PremiumCalculatorFormCar
                ...
                setCompulsoryValue={setCompulsoryValue}
                vehicleType="car"
