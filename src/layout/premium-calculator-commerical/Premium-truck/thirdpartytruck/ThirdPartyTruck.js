...
import PremiumCalculatorCommercialThirdParty from '../../../../components/PremiumCalculatorCommercialThirdParty';
      ...
      <SafeAreaView style={containerStyle.loginContainer}>
        <KeyboardAwareScrollView>
          <View style={{padding: 15}}>
            <View>
              <PremiumCalculatorCommercialThirdParty
                payload={payload}
            ...
            <View
              ...
              <View
                ...
                <View
                  ...
                  Commerical Vehicle ThirdParty Calculator
                  </Text>
                  <Pressable
                    onPress={() =>
                      setCalculationModalVisible(!calculationModalVisible)
